...
import com.knavid.finalproject.databinding.FragmentGenresBinding;
...
public class GenresFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = binding.textGenres;
        genresViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
